<?php
//
// This script is a customization of the ciniki-mods/core/scripts/manage.php
//
...
$qruqsp_themes = "/qruqsp-mods/core/ui/themes";
...
<?php } ?>
    <div id="mc_login">
        <div id="mcw_login" class="narrow">
            <?php print "<img id='logo' class='logo' src='$qruqsp_themes/default/img/logo.png'>";?>
            <br/>
            ...
            <form id="mc_login_form" name="mc_login_form" class="narrow" action="/ciniki-login.php" onsubmit="M.auth();" target="login_target" method="POST">
                <div class="section">
                    <h2>Email or Call Sign</h2>
                    <table class="list noheader form" cellspacing='0' cellpadding='0'>
                        <tr class="textfield"><td class="input"><label style="display:none;" for="username">Email or Call Sign</label><input id="username" type="text" maxlength="255" name="username"></td></tr>
                    </table>
                    <h2>Password</h2>
                    <table class="list noheader form" cellspacing='0' cellpadding='0'>
